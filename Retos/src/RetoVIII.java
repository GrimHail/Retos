...
public class RetoVIII {
    public static void main(String[] args) {
        ...
        String eleccion = null, eleccionUsuario, preg;
        int numRandom;
        ...
        System.out.println("===============================================================================");
        System.out.println("|                                                                             |");
        System.out.print("|   ¿Quieres Jugar Piedra, Papel o Tijera? (Si o No): ");
        ...
        while (preg.equals("si")){
            ...
            //Parsear el metodo random de la subclase random, la clase random es Math   
            numRandom = num.nextInt(3)+1;
            ...
            //Capturamos el dato dentro de elleccionUsuario y transformamos a minuscula
            ...
            System.out.println("===============================================================================");
            System.out.println("|                                                                             |");
            System.out.print("|   ¿Quieres seguir Jugando Piedra, Papel o Tijera? (Si o No): ");
            //Capturamos el dato dentro de elleccionUsuario y trnasformamos a minuscula
            preg = sc.next().toLowerCase();
            System.out.println("|                                                                             |");
            System.out.println("===============================================================================");
